...
describe('je suis la description du groupe de test pour le composant ListeFilms', () => {
    ...
    test('Vérifie la tuile d\'un film', () => {
        ...
        render(<TuileFilm data={mockFilm} />); // on sattend a ce que ce soit qqchose
        expect(screen.getByText(mockFilm.titre)).toBeInTheDocument();

        //pour tester juste la valeure dun attribut
